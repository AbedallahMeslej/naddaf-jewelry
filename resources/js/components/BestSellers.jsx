...
const products = [
  { id: 6, name: 'Classic Gold Ring', category: 'Rings', price: 189, rating: 5, reviews: 214, img: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&q=80' },
  { id: 7, name: 'Diamond Necklace', category: 'Necklaces', price: 349, rating: 5, reviews: 186, img: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&q=80' },
  { id: 8, name: 'Gold Earrings', category: 'Earrings', price: 129, rating: 4, reviews: 143, img: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&q=80' },
  { id: 9, name: 'Luxury Bracelet', category: 'Bracelets', price: 229, rating: 5, reviews: 98, img: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=400&q=80' },
  { id: 10, name: 'Rose Gold Pendant', category: 'Necklaces', price: 159, rating: 4, reviews: 167, img: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=400&q=80' },
]
    ...
    <div className="py-16 px-8" style={{backgroundColor: '#FAF8F5'}}>
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-xs font-semibold tracking-[0.3em] mb-2" style={{color: '#E8C97A'}}>TOP SELLING</p>
            <h2 className="text-3xl md:text-4xl font-bold" style={{color: '#1a1a1a'}}>Best Sellers</h2>
          </div>
          ...
          {products.map(product => (
            <div key={product.id} className="group cursor-pointer">
              <div className="relative rounded-2xl overflow-hidden mb-4" style={{backgroundColor: '#f0ebe3'}}>
                ...
                <div className="absolute top-3 left-3 px-2 py-1 rounded-full text-xs font-bold" style={{backgroundColor: '#6B1A2A', color: '#FAF8F5'}}>
                  #1 Seller
                </div>
